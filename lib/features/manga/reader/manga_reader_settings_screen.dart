...
class MangaReaderSettingsScreen extends ConsumerWidget {
  ...
  String _modeLabel(BuildContext context, MangaReaderMode mode) => switch (mode) {
    MangaReaderMode.vertical => _t(context, 'Vertical', 'عمودي'),
    MangaReaderMode.pagedLtr => _t(context, 'Left to right', 'من اليسار لليمين'),
    MangaReaderMode.pagedRtl => _t(context, 'Right to left', 'من اليمين لليسار'),
    MangaReaderMode.verticalContinuous =>
      _t(context, 'Vertical continuous', 'عمودي مستمر'),
    MangaReaderMode.webtoon => _t(context, 'Webtoon', 'ويب تون'),
    MangaReaderMode.horizontalContinuous =>
      _t(context, 'Horizontal continuous', 'أفقي مستمر'),
    MangaReaderMode.horizontalContinuousRtl =>
      _t(context, 'Horizontal continuous (RTL)', 'أفقي مستمر (RTL)'),
  };

  String _scaleLabel(BuildContext context, MangaReaderScaleType type) => switch (type) {
    MangaReaderScaleType.fitScreen => _t(context, 'Fit screen', 'ملاءمة الشاشة'),
    MangaReaderScaleType.stretch => _t(context, 'Stretch', 'تمديد'),
    MangaReaderScaleType.fitWidth => _t(context, 'Fit width', 'ملاءمة العرض'),
    MangaReaderScaleType.fitHeight => _t(context, 'Fit height', 'ملاءمة الارتفاع'),
    MangaReaderScaleType.originalSize => _t(context, 'Original size', 'الحجم الأصلي'),
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(
            title: Text(
              _t(context, 'Double-tap animation speed', 'سرعة حركة النقر المزدوج'),
            ),
            subtitle: SegmentedButton<int>(
              segments: <ButtonSegment<int>>[
                ButtonSegment(value: 0, label: Text(_t(context, 'Off', 'بدون'))),
                ButtonSegment(value: 1, label: Text(_t(context, 'Normal', 'عادي'))),
          ...
          SwitchListTile(
            title: Text(
              _t(context, 'Automatic double page', 'صفحتان تلقائيًا'),
            ),
            subtitle: Text(
              _t(
                context,
          ...
          SwitchListTile(
            ...
            onChanged: (value) =>
                update((s) => s.copyWith(keepScreenOn: value)),
          ),
          SwitchListTile(
          ...
          SwitchListTile(
            title: Text(_t(context, 'Show page gaps', 'إظهار الفواصل بين الصفحات')),
            value: settings.showPageGaps,
            onChanged: (value) =>
                update((s) => s.copyWith(showPageGaps: value)),
          ),
          SwitchListTile(
            title: Text(
              _t(
            ...
            onChanged: (value) => update(
              (s) => s.copyWith(autoReadDuplicateChapters: value),
            ),
          ),
          ListTile(
            title: Text(
            ...
            subtitle: Slider(
              ...
              onChanged: (value) => update(
                (s) => s.copyWith(webtoonSidePadding: value.toInt()),
              ),
            ),
          ),
          ...
          ListTile(
            ...
            subtitle: Slider(
              ...
              onChanged: (value) => update(
                (s) => s.copyWith(navigationLayout: value.toInt()),
              ),
            ),
          ),
          ListTile(
            ...
            subtitle: Slider(
              ...
              onChanged: (value) => update(
                (s) => s.copyWith(tappingInversion: value.toInt()),
              ),
            ),
          ),
          SwitchListTile(
            title: Text(_t(context, 'Navigate while zoomed', 'التنقل أثناء التكبير')),
            value: settings.navigateToPan,
            onChanged: (value) =>
                update((s) => s.copyWith(navigateToPan: value)),
          ),
          ListTile(
            title: Text(
            ...
            subtitle: Slider(
              ...
              onChanged: (value) => update(
                (s) => s.copyWith(readerHideThreshold: value.toInt()),
              ),
            ),
          ),
          SwitchListTile(
            ...
            onChanged: (value) =>
                update((s) => s.copyWith(landscapeZoom: value)),
          ),
          if (settings.landscapeZoom)
            ListTile(
              title: Text(_t(context, 'Zoom start position', 'بداية موضع التكبير')),
              subtitle: Slider(
                min: 0,
                max: 2,
                divisions: 2,
                ...
                onChanged: (value) => update(
                  (s) => s.copyWith(zoomStartPosition: value.toInt()),
                ),
              ),
            ),
          SwitchListTile(
          ...
          SwitchListTile(
            title: Text(
              _t(context, 'Double tap to zoom', 'نقر مزدوج للتكبير'),
            ),
          ...
          SwitchListTile(
            title: Text(_t(context, 'Flash on page change', 'وميض عند تغيير الصفحة')),
          ...
          if (settings.flashOnPageChange) ...<Widget>[
            ListTile(
              ...
              subtitle: Slider(
                ...
                onChanged: (value) => update(
                  (s) => s.copyWith(flashDurationMs: value.toInt()),
                ),
              ),
            ),
            ListTile(
              ...
              subtitle: Slider(
                ...
                onChanged: (value) => update(
                  (s) => s.copyWith(flashInterval: value.toInt()),
                ),
              ),
            ),
          ],
